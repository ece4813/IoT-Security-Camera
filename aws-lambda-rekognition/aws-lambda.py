...
# table = dynamodb.Table('raspcam-detections')
...
def lambda_handler(event, context):
    ...
    try:
        ...
        human_labels = ["Human", "People", "Person", "Selfie", "Face", "Portrait", "Child", "Kid","Beard", "Afro Hairstyle", "Man", "Accessory","Accessories", "Glasses", "Clothing", "Clothes", "Apparel", "Head"]
        human_detected = False
        for label in response_rekognition["Labels"]:
            if label["Name"] in human_labels and label["Confidence"] > 90:
                human_detected = True
                table.put_item(Item={"type": label['Name'],"timestamp": time })
                break
        ...
        for label in response_rekognition["Labels"]:
            if label["Name"] in weapon_labels and label["Confidence"] > 90:
                ...
                table3.put_item(Item={"type": label['Name'],"timestamp": time })
